...
SpriteBehavior::SpriteBehavior(sf::Texture& tex, float x, float y, TransformAttribute* transform, sf::RenderWindow* window)
	: _transform(transform), _window(window), _sprite(tex)
{
	_sprite.setOrigin(x, y);
}

SpriteBehavior::SpriteBehavior(sf::Texture& tex, sf::IntRect rect, float x, float y, TransformAttribute* transform, sf::RenderWindow* window)
